---
title: "Comparing benchmarking experiment results from Release 2.5 and Release 2.6"
...
downloadDat |>
  ...
  scale_color_manual(
    ...
    values = c("goldenrod", "grey70", "steelblue")
  ) +
...
compareDataRacePlot <- function(downloadDat, removeOutliers = FALSE) {
  downloadDat |>
    ...
    scale_color_manual(values = c("gray40", "forestgreen", "plum3")) +
    guides(color = guide_legend(override.aes = list(alpha = 1))) +
    theme_bw() +
    theme(
