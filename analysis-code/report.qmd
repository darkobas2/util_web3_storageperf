...
## Modeling the effects of erasure codes and retrieval strategies
...
#| fig-width: 8
#| fig-height: 6
#| fig-cap: Model fits to the standardized (z-score) download time data, for the DATA download strategy only (RACE is omitted). Blue points and error bars are as in @fig-erasure-zscore; the black curves are the predictions from the fitted models.
